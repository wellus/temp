...
variable "attach_s3_standard_bucket_policy" {
  description = "Controls if S3 bucket should have the standard policy attached from a template"
  type        = bool
  default     = false
}
...
variable "s3_bucket_policy" {
  type        = string
  description = "The name of the json policy file"
  default     = "default"
}
...
variable "environment" {
  type        = string
  description = "Environment into which resource is deployed. e.g. 'eu-west-2', OR 'prod', 'staging', 'dev', 'UAT'"
}
